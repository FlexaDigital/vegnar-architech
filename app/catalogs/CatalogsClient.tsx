...
const catalogs = [
  {
    ...
    fileUrl: "/download/Aluminium Ralling System.pdf",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Download Our E-Catalogs
            </h2>
            <p className="text-gray-600 mt-4 text-lg max-w-xl mx-auto">
              Access our beautifully designed catalogs to explore detailed
              product ranges.
            </p>
          </motion.div>
            ...
            {catalogs.map((catalog, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                  <div>
                    <h3 className="text-xl font-semibold text-[#2B4257] mb-2">
                      {catalog.title}
                    </h3>
