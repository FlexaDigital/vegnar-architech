          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-center justify-center text-center p-5 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 shadow-md"
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#A7C7E7] mb-1 drop-shadow">
                  {stat.number}
                </div>
